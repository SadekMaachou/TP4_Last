...
public class MsScolariteApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Etudiant etudiant=etudiantRep.save(new Etudiant(null,"sadek",new SimpleDateFormat("yyyy-MM-dd").parse("2002-03-19"),new SimpleDateFormat("yyyy-MM-dd").parse("2023-03-19"),"promo2024",etablissement,1L,1L,formation));
        Etudiant etudiant1=etudiantRep.save(new Etudiant(null,"yahya",new SimpleDateFormat("yyyy-MM-dd").parse("2002-03-19"),new SimpleDateFormat("yyyy-MM-dd").parse("2023-03-19"),"promo2024",etablissement,1L,1L,null));
        Etudiant etudiant2=etudiantRep.save(new Etudiant(null,"jbira",new SimpleDateFormat("yyyy-MM-dd").parse("2002-03-19"),new SimpleDateFormat("yyyy-MM-dd").parse("2023-03-19"),"promo2024",etablissement,1L,1L,null));
